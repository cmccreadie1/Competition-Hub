...
function calculateAndRenderZoneLeaderboard(dayNum, containerId) {
    ...
    zones.forEach(zoneName => {
        ...
        htmlOutput += `
        <div style="background: rgba(30, 41, 59, 0.85); border: 1px solid var(--border); overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.15);">
...
function calculateAndRenderIndividualLeaderboard(containerId) {
    ...
    let html = `
    <div style="background: rgba(30, 41, 59, 0.85); border: 1px solid var(--border); border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.2);">
